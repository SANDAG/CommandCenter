...
<body>
  <div class="row">
    <div class="col-md-12">
      ...
      <h3>Scenario <strong><a href="<c:url value="/jobs/${job.status == RUNNING ? 'running' : 'complete'}" />?highlight=${job.id}">${job.scenario}</a></strong>&#39;s log file <strong>${path}</strong></h3>
